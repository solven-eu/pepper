...
public class CreateCollectionDump {
	...
	public static abstract class CollectionTestData {
		...
		public CollectionTestData() {
			...
			/*
			 * List of classes under test. Space separated class from static method 1 entry means use constructor 2
			 * entries means use static method from class
			 */
						...
						if (!useEmpty()) {
							try {
								...
								for (int i = to; i <= COUNT; i += 1) {
									// System.out.println(cl.getClass()+" "+arrayVals.size()+" "+delayedVals.size()+"
									// "+delayedVals2.size());
		...
		private Object[][] buildArgs(List<String> arrayVals, List<Delayed> delayedVals) {
			...
			Object[][] args = new Object[][] { {},
					...
					{ queue },
					{ queue },
					{ arrayVals, String.class },
					{ arrayVals, String.class },
					{ setVals, String.class },
					{ queue, String.class },
					{ setVals, String.class },
					{ setVals, String.class },
					{ values[1] },
		...
		private Class[][] buildArgTypes() {
			...
			Class[][] cons = new Class[][] { {},
					...
					{ Collection.class },
					{ Deque.class },
					{ Collection.class, Class.class },
					{ List.class, Class.class },
					{ Set.class, Class.class },
					{ Queue.class, Class.class },
					{ SortedSet.class, Class.class },
					{ NavigableSet.class, Class.class },
					{ Object.class },
					{ Set.class },
					{ Collections.class },
					{ Enumeration.class },
	...
	public static class MapTestData {
		...
		public MapTestData() {
			...
			/*
			 * List of maps under test 1 entry means use constructor 2 entries means use static method from class
			 */
		...
		private Object[][] buildArgs(Map<String, String> mapVals, Map<Enum, String> enumVals) {
			...
			try {
				...
				ct1 = new CompositeType("composite test",
						"a composite type",
						mapVals.keySet().toArray(new String[COUNT]),
						mapVals.values().toArray(new String[COUNT]),
						st);
				tt1 = new TabularType("tabular test",
						"testing tabular types with strings",
						ct1,
						mapVals.keySet().toArray(new String[COUNT]));
			...
			Object[][] args = new Object[][] { {},
					...
					{ mapVals },
					{ mapVals },
					{ mapVals, String.class, String.class },
					{ mapVals, String.class, String.class },
					{ mapVals, String.class, String.class },
					{ keys[1], values[1] },
		...
		private Class[][] buildArgTypes() {
			Class[][] cons = new Class[][] { {},
					...
					{ SortedMap.class },
					{ NavigableMap.class },
					{ Map.class, Class.class, Class.class },
					{ SortedMap.class, Class.class, Class.class },
					{ NavigableMap.class, Class.class, Class.class },
