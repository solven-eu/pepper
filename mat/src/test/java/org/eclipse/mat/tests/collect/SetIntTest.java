...
public class SetIntTest {
	...
	/**
	 * Check remove works as expected and that remaining entries are not affected.
	 */
	@Test
	...
	public void testSetInt5() {
		...
		assertThat("Worst more for group " + worstj + " than 10 times best for group " + bestj, //$NON-NLS-1$ //$NON-NLS-2$
				worst,
				lessThanOrEqualTo(Math.max(100, 10 * best)));
	}
