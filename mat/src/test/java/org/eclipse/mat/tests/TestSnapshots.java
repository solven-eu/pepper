...
public class TestSnapshots {
	...
	public static final String SUN_JDK6_31_64BIT_HPROFAGENT_NOCOMPRESSED_OOPS =
			"dumps/sun_jdk6_31_hprofagent_nocompressedOops.hprof";
	public static final String SUN_JDK6_31_64BIT_HPROFAGENT_COMPRESSED_OOPS =
			"dumps/sun_jdk6_31_hprofagent_compressedOops.hprof";
	...
	public static final String HISTOGRAM_SUN_JDK6_30_64BIT_COMPRESSED_OOPS =
			"dumps/sun_jdk6_30_x64_compressedOops.notes.txt";
	public static final String HISTOGRAM_SUN_JDK6_30_64BIT_NOCOMPRESSED_OOPS =
			"dumps/sun_jdk6_30_x64_nocompressedOops.notes.txt";
	public static final String HISTOGRAM_SUN_JDK6_31_64BIT_HPROFAGENT_NOCOMPRESSED_OOPS =
			"dumps/sun_jdk6_31_hprofagent_nocompressedOops.txt";
	public static final String HISTOGRAM_SUN_JDK6_31_64BIT_HPROFAGENT_COMPRESSED_OOPS =
			"dumps/sun_jdk6_31_hprofagent_compressedOops.txt";
	...
	public static final boolean DTFJreadJavacore142 =
			Platform.getBundle("com.ibm.dtfj.j9").getVersion().compareTo(Version.parseVersion("1.5")) < 0;
	...
	public static final boolean DTFJreadSystem142 = Platform.getBundle("com.ibm.dtfj.api")
			.getVersion()
			.compareTo(Version.parseVersion("1.12.29003.201808011034")) < 0;
	...
	/**
	 * This snapshot can be disposed as it won't be used again. The dump file itself is not deleted, but will be tidied
	 * up at the end.
	 *
	 * @param name
	...
	public static ISnapshot getSnapshot(String dumpname, Map<String, String> options, boolean pristine) {
		// DTFJ 1.5 cannot read javacore 1.4.2 dumps anymore
		assumeTrue("DTFJ >= 1.5 cannot read javacore 1.4.2 dumps",
				!dumpname.equals(TestSnapshots.IBM_JDK142_32BIT_JAVA) || DTFJreadJavacore142);
		// DTFJ 1.12.29003.201808011034 cannot read 1.4.2 system dumps anymore
		assumeTrue("DTFJ >= 1.12.29003.201808011034 cannot read 1.4.2 system dumps",
				!dumpname.equals(TestSnapshots.IBM_JDK142_32BIT_SYSTEM) || DTFJreadSystem142);
		try {
				...
				try {
					...
					try {
						...
						while (totalTransferred < needTransferred) {
							totalTransferred +=
									sourceChannel.transferTo(totalTransferred, needTransferred, destinationChannel);
						}
					} finally {
				...
				for (ISnapshot sn : snapshots.values()) {
					try {
						...
						if (cls != null && !cls.isEmpty())
							System.out.println("snapshot " + sn.getSnapshotInfo().getPath()
									+ " hasn't been disposed at the factory");
