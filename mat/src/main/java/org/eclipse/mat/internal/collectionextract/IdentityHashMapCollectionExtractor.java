...
public class IdentityHashMapCollectionExtractor extends FieldSizeArrayCollectionExtractor implements IMapExtractor {
	...
	/**
	 * Can't calculate the collision ratio as we don't have the identityHashCode for the keys, even if we did know the
	 * hash algorithm.
	 */
	...
	/**
	 * Complete guess as to collision ratio. Look for consecutive entries - perhaps they were caused by a linear probe.
	 */
	public Double getCollisionRatio(IObject coll) throws SnapshotException {
		...
		// return 0.5*(double)x;
		/*
		 * Slightly better than the above calculation. Simulated with random fills of hash tables Quadratic going
		 * through (0,0),(0.5,0.1975),(1,0.5)
		 */
