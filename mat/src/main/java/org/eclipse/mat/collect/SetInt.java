...
public final class SetInt implements Serializable {
	...
	/**
	 * Return a serializable version of this SetInt. Previous versions of the code use an old hash function and
	...
	/**
	 * Deserialize a SetInt. Previous versions serialized the object directly using an old hash function, and the
	 * current version does the same for compatibility, so rebuild allowing a new hash function.
	 *
