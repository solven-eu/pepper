...
/**
 * Converts a result to a report. See extension point
 * <a href="../../../../schema/renderer.exsd">org.eclipse.mat.report.renderer</a>
 */
public interface IOutputter {
	...
	public interface Context {
		...
		/**
		 * Add a {@link IResult} from a {@link DetailResultProvider} to the report.
		 *
		 * @param name
		 * @param result
		 * @return a String which can be used by the IOutputter to identify the formatted result
		 */
		 ...
		 *
		 * @return true if the totals row should be displayed
		 */
		 ...
		 * @param key
		 * @param defaultValue
		 *            the value to be used if no parameter with that key is set.
	 ...
	 *
	 * @param context
	 *            the context, which controls how the output should be done
	 * @param result
