	...
	public static class Enhancer {
		...
		public IParsingEnhancer parser() {
			try {
				...
				Logger.getLogger(getClass().getName())
						.log(Level.SEVERE,
								MessageUtil.format(Messages.EnhancerRegistry_ErrorCreatingParser,
										configElement.getAttribute("parser")), //$NON-NLS-1$
								e);
				return null;
			}
		}
		...
		public IRuntimeEnhancer runtime() {
			try {
				...
				Logger.getLogger(getClass().getName())
						.log(Level.SEVERE,
								MessageUtil.format(Messages.EnhancerRegistry_ErrorCreatingRuntime,
										configElement.getAttribute("runtime")), //$NON-NLS-1$
								e);
				return null;
			}
		}
