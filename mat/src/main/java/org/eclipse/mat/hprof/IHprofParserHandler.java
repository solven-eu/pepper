...
public interface IHprofParserHandler {
	...
	public class HeapObject {
		...
		public static HeapObject forPrimitiveArray(long objectAddress,
				byte elementType,
				int arraySize,
				long filePosition) {
		...
		public static HeapObject forObjectArray(long objectAddress,
				long classID,
				int arraySize,
				long[] ids,
				long filePosition) {
		...
		public static HeapObject forInstance(long objectAddress,
				long classID,
				byte[] instanceData,
				long filePosition,
				int idSize) {
