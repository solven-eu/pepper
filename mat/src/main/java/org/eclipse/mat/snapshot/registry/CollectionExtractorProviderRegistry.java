...
public final class CollectionExtractorProviderRegistry extends RegistryReader<ICollectionExtractorProvider> {
	...
	private final Map<ICollectionExtractorProvider, List<CollectionExtractionInfo>> providerMap =
			new HashMap<ICollectionExtractorProvider, List<CollectionExtractionInfo>>();
	...
	protected ICollectionExtractorProvider createDelegate(IConfigurationElement configElement) throws CoreException {
		ICollectionExtractorProvider provider =
				(ICollectionExtractorProvider) configElement.createExecutableExtension("impl"); //$NON-NLS-1$
