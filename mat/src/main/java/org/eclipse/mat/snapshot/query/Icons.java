...
public final class Icons {
	...
	/**
	 * A Java class grey/green inbound icon. Used to show that some of the instances of the class have already been
	 * seen.
	 */
	public static final URL CLASS_IN_MIXED = build("in/class_mixed");

	/**
	 * A Java class grey/green outbound icon. Used to show that some of the instances of the class have already been
	 * seen.
	 */
	...
	/**
	 * Construct an inbound reference icon URL for the current object pointing to the right image and containing the
	 * right GC decoration.
	 *
	 * @param snapshot
	 *            the snapshot
	...
	/**
	 * Construct an outbound reference icon URL for the current object pointing to the right image and containing the
	 * right GC decoration.
	 *
	 * @param snapshot
	 *            the snapshot
