...
/**
 * Extracts detailed information about a thread. This is used by the thread queries ThreadOverviewQuery and
 * ThreadInfoQuery. Implementations of this interface need to be registered using the
 * <code>org.eclipse.mat.api.threadResolver</code> extension point.
 */
public interface IThreadDetailsResolver {
	 ...
	 *
	 * @param thread
	 *            to extract the information from and to attach the information
	 * @param listener
