...
/**
 * This class holds the histogram data on the objects found in the object set for which a histogram was computed
 * (aggregated per class loader).
 */
public class ClassLoaderHistogramRecord extends HistogramRecord {
	 ...
	 * @param classLoaderId
	 *            the id of the class loader object
	 * @param classHistogramRecords
	 *            the histogram details of all the classes loaded by this loader
	 * @param numberOfObjects
	 * @param usedHeapSize
	 * @param retainedHeapSize
	 */
	public ClassLoaderHistogramRecord(String label,
			int classLoaderId,
	 ...
	 *
	 * @return id of the class loader this class loader histogram record stands for
	 */
	 ...
	 *
	 * @return collection of the class histogram records this class loader histogram record stands for
	 */
	 ...
	 *            whether to calculate the size if not already available
	 * @param approximation
	 *            whether to use an approximation to the retained size (sum of the individual retained sizes)
	 * @param listener
