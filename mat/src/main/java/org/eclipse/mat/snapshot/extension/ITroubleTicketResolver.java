...
/**
 * Interface for a trouble-ticket component resolver. A trouble-ticket component resolver can propose a proper component
 * (e.g. MAT) within a troubleshooting system (e.g. bugzilla) for a specific class or classloader (e.g.
 * org.eclipse.mat.parser.internal.SnapshotImpl).
 *
 * This information is exposed in the Leak suspects reports. It could help the user who generated the report to open a
 * trouble ticket in the proper component, and this is especially helpful when the user is not familiar with the
 * analyzed coding.
 *
 * Implementations of this interface need to be registered using the <code>org.eclipse.mat.api.ticketResolver</code>
 * extension point.
 */
