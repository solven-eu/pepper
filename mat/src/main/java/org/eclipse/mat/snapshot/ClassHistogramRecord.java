...
public class ClassHistogramRecord extends HistogramRecord {
	 ...
	 *            the number of objects of that class
	 * @param usedHeapSize
	 *            the space used by those objects
	 * @param retainedHeapSize
	 *            the total of the size of all the objects retained by those objects. 0 means calculate when required,
	 *            negative means approximate size, positive means exact retained size is known.
	 */
	 ...
	 *            the id of the class
	 * @param objectIds
	 *            the ids of objects of that class
	 * @param usedHeapSize
	 *            the space used by those objects
	 * @param retainedHeapSize
	 *            the total of the size of all the objects retained by those objects. 0 means calculate when required,
