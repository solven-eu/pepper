...
/**
 * Container class for annotated objects and arguments. Holds information about an annotated object (e.g. a query) and
 * all its parameters and the current values of the arguments.
 */
