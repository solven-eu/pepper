...
/**
 * This result is rendered as text. The input can be plain text, or HTML. Any object addresses can be rendered as links
 * and allow the user to execute queries on the objects.
 *
 * @noextend
 */
