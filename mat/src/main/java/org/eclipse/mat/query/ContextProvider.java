...
/**
 * Base class for context provider which is an object which returns the heap objects represented by an arbitrary row in
 * a table/tree. This is used by {@link IResult#getResultMetaData()} to provide additional information about rows in a
 * report.
 *
...
public abstract class ContextProvider {
	...
	/**
	 * The label for this context provider. Used for context menus to provide a root menu item, with all the queries for
	 * this context as sub-items.
	 *
	 * @return the label
	 */
	 ...
	 *
	 * @param other
	 *            the other context provider to compare
	...
	/**
	 * Returns an icon which could be used on context menus as a top level to represent this entire type of data
	 * available from an {@link IStructuredResult}.
	 *
