...
public abstract class DetailResultProvider {
	...
	/**
	 * Constructor of object to enhance details of rows of a table. Used to give more detailed information about rows in
	 * a table as another IResult.
	 *
	 * @param label
	 ...
	 *
	 * @param row
	 *            the opaque data representing the row
	 ...
	 *
	 * @param row
	 *            the opaque object for finding the row
	 * @param listener
