...
/**
 * This class formats an instance of {@link org.eclipse.mat.query.Bytes}, {@link java.lang.Long},
 * {@link java.lang.Integer}, or {@link java.lang.Short} based on the currently configured
 * {@link org.eclipse.mat.query.BytesDisplay} preference.
 *
 * @since 1.5
 */
public class BytesFormat extends Format {
	...
	/**
	 * The defaultFormat is used when we are not formatting as {@link org.eclipse.mat.query.BytesDisplay#Bytes}.
	 */
	 ...
	 * {@link org.eclipse.mat.query.BytesDisplay#Bytes}, always use {@code encapsulatedNumberFormat}; otherwise, use
	...
	/**
	 * If {@code obj} is an instance of Bytes, long, integer or short, then consider the bytes display preference when
	 * formatting the value. Otherwise, format {@code obj} using the default formatter.
	 */
	@Override
	...
	/**
	 * Parses the input string according to the display mode. Returns a {@link Bytes} object
	 */
	@Override
