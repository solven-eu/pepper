...
public interface IResultTree extends IStructuredResult {
	 ...
	 *
	 * @return a list of all the root elements of the tree as opaque row objects representing each row which can be
	 *         passed to {@link IResultTree#getChildren(Object)} or {@link IStructuredResult#getContext(Object)} or
	 ...
	 *
	 * @param element
	 *            the opaque object used to indicate which branch
	 ...
	 *
	 * @param parent
	 *            The row object as returned by the {@link IResultTree#getElements()} or
