...
public interface IQueryContext {
	 ...
	 *
	 * @param type
	 *            the type the data should be converted to
	 * @param advice
	...
	/**
	 * Map an id to a readable form. For example the hex-address with 0x as a prefix. Reverse of {@link #mapToObjectId}
	 *
	 * @param objectId
	 *            The 0-based internal identifier used within MAT.
	 * @return readable external version
	 * @throws SnapshotException
	 *             if the objectId does not match to a valid object.
	 * @see #mapToObjectId
	 */
	String mapToExternalIdentifier(int objectId) throws SnapshotException;

	/**
	 * Map readable form to internal id. Reverse of {@link #mapToExternalIdentifier}.
	 *
	 * @param externalIdentifier
	 *            as provided by {@link #mapToExternalIdentifier}.
	 ...
	 *
	 * @param type
	 *            The Java type of an argument to be supplied with data from this context.
	 * @param advice
	 *            Further details about the argument to be supplied with data.
	 ...
	 *
	 * @param type
	 *            The Java type of the argument.
	 * @param advice
	 *            Further details about the argument.
	 * @param value
	 *            The value of the argument held in the context.
	 ...
	 *
	 * @param type
	 *            The Java type of the destination argument.
	 * @param advice
	 *            Further details about the argument.
	 * @param args
	 *            The source to be converted
	 * @param pos
	 *            Used to index through the array of Strings.
