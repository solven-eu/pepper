...
public final class RefinedResultBuilder {
	 ...
	 *
	 * @param context
	 *            the context holding details about what was selected etc.
	 * @param subject
	...
	public RefinedResultBuilder(IQueryContext context, IStructuredResult subject) {
		...
		refinedResult.selectionProvider =
				subject instanceof ISelectionProvider ? (ISelectionProvider) subject : ISelectionProvider.EMPTY;
	...
	public void setSortOrder(int columnIndex, SortDirection direction) {
		...
		boolean isPreSorted =
				refinedResult.metaData.isPreSorted() && columnIndex == refinedResult.metaData.getPreSortedColumnIndex()
