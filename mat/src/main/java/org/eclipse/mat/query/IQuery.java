...
/**
 * Interface representing a query on the heap dump. Arguments can be injected into the query using public fields marked
 * with the {@link Argument} annotation. Typical arguments for a {@link org.eclipse.mat.snapshot.query.SnapshotQuery}
 * are
 * <ul>
 ...
 * <li>enum - an enum</li>
 * </ul>
 * The implementation can be tagged with the following annotations to control the placement and help in the query menus.
 * <ul>
 ...
 * </ul>
 *
 * Implementations of this interface need to be registered using the <code>org.eclipse.mat.report.query</code> extension
 * point.
 */
public interface IQuery {
	/**
	 * The execute method is called after all arguments have been injected into the query instance. Typical results are
	 * {@link TextResult}, {@link CompositeResult}, {@link SectionSpec} etc.
	 *
	 * @param listener
