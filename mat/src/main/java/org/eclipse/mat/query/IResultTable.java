...
public interface IResultTable extends IStructuredResult {
	 ...
	 * @param rowId
	 *            The row number.
	 * @return an opaque row object representing this row which can be passed to
	 *         {@link IStructuredResult#getContext(Object)} or {@link IStructuredResult#getColumnValue(Object, int)}.
	 */
