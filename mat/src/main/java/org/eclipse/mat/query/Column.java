...
public final class Column {
	...
	/**
	 * Sort direction of the column. To sort the values, either the attached formatter is used or the natural sorting
	 * order.
	 */
	public enum SortDirection {
		...
		/**
		 * Get the default ordering for a column. Currently descending for numeric, ascending for the rest.
		 *
		 * @param column
	 ...
	 *            a type of the column, such as float, int, Double
	 * @param align
	 *            cell alignment - see {@link Column.Alignment} for the choices
	 * @param direction
	 *            sorting direction
	 * @param formatter
	 ...
	 *
	 * @param decorator
	 *            the decorator to allow a prefix or suffix
	 * @return the original column to allow chaining
	 */
	...
	/**
	 * Returns true if the columns represents a numeric type, i.e. if it is assignable to number or one of the primitive
	 * numeric types.
	 *
	...
	public boolean equals(Object obj) {
		...
		/*
		 * Not all of our Comparators implement equals on themselves properly and sometimes the comparator changes
		 */
