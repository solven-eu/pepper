 ...
 * <p>
 * Rows in tables or tree represent a set of objects. Using a {@link ContextProvider}, the Memory Analyzer determines
 * the object set associated with a row and is able to execute other queries on this set.
 * <p>
