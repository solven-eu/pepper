...
public final class QueryObjectLink {
	...
	/**
	 * @param url
	 *            The String representation of a Memory Analyzer URL, starting mat://
	 * @return null if the URL does not present a proper Memory Analyzer Object otherwise an internal MAT representation
	 *         of the URL.
	 */
