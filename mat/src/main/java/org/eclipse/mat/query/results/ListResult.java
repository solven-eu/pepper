...
/**
 * A list of items such as properties as a result table. Compare to {@link PropertyResult} which extracts and displays
 ...
 * </pre>
 *
 * The column names are derived from the property names. If the names are required to be internationalized then a
 * BeanInfo can be provided for the type which provides a display name for the property descriptor.
 */
