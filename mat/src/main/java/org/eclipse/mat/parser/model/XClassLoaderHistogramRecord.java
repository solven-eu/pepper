...
public final class XClassLoaderHistogramRecord extends ClassLoaderHistogramRecord {
	 ...
	 *            summary of all the classes loaded by the class loader
	 * @param numberOfObjects
	 *            the total number of objects
	 * @param usedHeapSize
	 *            the total shallow size of the loader, classes and objects
	 * @param retainedHeapSize
	 *            the total retained size of the loader, classes and objects
	 */
	public XClassLoaderHistogramRecord(String label,
			int classLoaderId,
	...
	public long calculateRetainedSize(ISnapshot snapshot,
		...
		if (object instanceof IClassLoader) {
			retainedHeapSize = ((IClassLoader) object)
					.getRetainedHeapSizeOfObjects(calculateIfNotAvailable, approximation, listener);
			return retainedHeapSize;
		} else {
