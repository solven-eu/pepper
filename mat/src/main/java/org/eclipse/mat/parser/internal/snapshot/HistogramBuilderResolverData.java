...
/**
 * @deprecated Use {@link HistogramBuilder#toHistogram(org.eclipse.mat.parser.internal.SnapshotImpl, boolean)} instead
 */
@Deprecated
public class HistogramBuilderResolverData {
	...
	public HistogramBuilderResolverData(String classLabel,
			long classUsedPermSize,
