	...
	static class GreaterThan extends RelationalOperation {
		...
		Object eval(Object left, Object right) {
			if (!(left instanceof Comparable))
				throw new UnsupportedOperationException(MessageUtil
						.format(ERR_NO_COMPARABLE, this.args[0], left, left.getClass().getName(), getSymbol()));
			if (!(right instanceof Comparable))
				throw new UnsupportedOperationException(MessageUtil
						.format(ERR_NO_COMPARABLE, this.args[1], right, right.getClass().getName(), getSymbol()));
		...
		public Object compute(EvaluationContext ctx) throws SnapshotException, OperationCanceledException {
			...
			if (obj2 instanceof List) {
				...
				throw new UnsupportedOperationException(
						MessageUtil.format(Messages.Operation_Error_ArgumentOfUnknownClass, obj2.getClass().getName()));
			}
		}
		...
		public Object compute(EvaluationContext ctx) throws SnapshotException, OperationCanceledException {
			...
			if (obj2 instanceof List) {
				...
				if (obj1 instanceof Integer)
					...
					throw new UnsupportedOperationException(
							MessageUtil.format(Messages.Operation_Error_NotInCannotCompare, obj1.getClass().getName()));
				...
				throw new UnsupportedOperationException(MessageUtil
						.format(Messages.Operation_Error_NotInArgumentOfUnknownClass, obj2.getClass().getName()));
			}
		}
