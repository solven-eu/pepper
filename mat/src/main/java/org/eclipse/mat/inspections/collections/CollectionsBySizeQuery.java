...
public class CollectionsBySizeQuery implements IQuery {
	...
	public IResult execute(IProgressListener listener) throws Exception {
		...
		Quantize.Builder builder = Quantize
				.valueDistribution(new Column(Messages.CollectionsBySizeQuery_Column_Length, int.class).noTotals());
	...
	private void runQuantizer(IProgressListener listener,
			Quantize quantize,
			ICollectionExtractor specificExtractor,
