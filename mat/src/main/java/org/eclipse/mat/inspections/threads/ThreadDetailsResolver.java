...
public class ThreadDetailsResolver implements IThreadDetailsResolver {
	...
	/**
	 * Formatter to display addresses etc. in hex Copied from
	 * {@link org.eclipse.mat.dtfj.ThreadDetailsResolver1.HexFormat}
	 */
	...
	public Column[] getColumns() {
		return new Column[] { (new Column(Messages.ThreadDetailsResolver_Priority, Integer.class).noTotals()),
