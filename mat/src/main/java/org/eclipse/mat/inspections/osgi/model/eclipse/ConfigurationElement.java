...
public class ConfigurationElement {
	...
	public ConfigurationElement(int objectId,
		...
		this.propertiesAndValues = propertiesAndValues != null ? propertiesAndValues.clone() : null; // clone to prevent
																										// SpotBugs
																										// warning
	}
	...
	/**
	 * Descriptor of the bundle contributing this element. This value can be null when the element is loaded from disk
	 * and the owner has been uninstalled.
	 *
