...
public class OQLQuery implements IQuery {
	...
	static class ObjectListResultImpl extends ObjectListResult.Outbound implements IOQLQuery.Result, IResultTree {
		String queryString;
	...
	static class ObjectTableResultImpl implements IOQLQuery.Result, IResultTable, IDecorator, IIconProvider {
		String queryString;
		List<?> objs;
		boolean hasIObjects;
