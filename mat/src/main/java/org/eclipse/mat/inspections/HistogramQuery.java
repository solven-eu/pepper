...
public class HistogramQuery implements IQuery {
	public enum Grouping {
		...
		BY_SUPERCLASS(Messages.HistogramQuery_GroupBySuperclass, Icons.SUPERCLASS), BY_CLASSLOADER(
				Messages.HistogramQuery_GroupByClassLoader, Icons.CLASSLOADER_INSTANCE), //
