...
/**
 * CollectionExtractors are used to extract from the heap dump the contents of an object which represents a collection
 * of a certain type. It knows the internal details of how the collection contents are stored and if the collection has
...
public interface ICollectionExtractor {
	...
	/**
	 * Check if fill ratio for the collection can be calculated, i.e. if it has some predefined capacity and actual
	 * size.
	 *
