...
@Subjects({ "org.eclipse.osgi.framework.internal.core.BundleLoaderProxy",
...
public class LeakingPlugins implements IQuery {
	...
	public IResult execute(IProgressListener listener) throws Exception {
		...
		Collection<IClass> classes =
				snapshot.getClassesByName("org.eclipse.osgi.framework.internal.core.BundleLoaderProxy", true); //$NON-NLS-1$
