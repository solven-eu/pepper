...
public class ExtensionPoint {
	...
	/*
	 * Not used info: private static final byte NAMESPACE = 3; // The name of the namespace of the extension point
	...
	/**
	 * Get extension point's unique identifier. This extension point is assigned a unique identifier by the OSGi
	 * framework.
	 *
