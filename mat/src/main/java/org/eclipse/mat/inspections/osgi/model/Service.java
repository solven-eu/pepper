...
public class Service {
	 ...
	 *
	 * @return List&lt;BundleDescriptor&gt; list of descriptors of the bundles, using this service
	 */
	...
	public List<ServiceProperty> getProperties() {
		...
		if (keys.length != values.length) {
			MATPlugin.log(MessageUtil.format(Messages.Service_ErrorMsg_MismatchKeysServices,
