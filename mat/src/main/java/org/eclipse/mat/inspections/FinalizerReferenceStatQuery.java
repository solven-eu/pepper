...
public class FinalizerReferenceStatQuery implements IQuery {
	...
	public IResult execute(IProgressListener listener) throws Exception {
		return ReferenceQuery.execute("java\\.lang\\.ref\\.Finalizer", //$NON-NLS-1$
				snapshot, Messages.FinalizerReferenceStatQuery_Label_Referenced,
				Messages.FinalizerReferenceStatQuery_Label_Retained,
				Messages.FinalizerReferenceStatQuery_Label_StronglyRetainedReferents,
				listener);
	}
