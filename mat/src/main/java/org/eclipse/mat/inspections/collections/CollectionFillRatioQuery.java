...
public class CollectionFillRatioQuery extends AbstractFillRatioQuery implements IQuery {
	...
	public IResult execute(IProgressListener listener) throws Exception {
		...
		Quantize.Builder builder =
				Quantize.linearFrequencyDistribution(Messages.CollectionFillRatioQuery_Column_FillRatio,
						0,
						5.0000000000,
		...
		runQuantizer(listener,
				quantize,
				specificExtractor,
				collection,
				snapshot,
				objects,
				Messages.CollectionFillRatioQuery_ExtractingFillRatios);
