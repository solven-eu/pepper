...
public class PhantomReferenceStatQuery implements IQuery {
	...
	public IResult execute(IProgressListener listener) throws Exception {
		return ReferenceQuery.execute("java\\.lang\\.ref\\.PhantomReference", //$NON-NLS-1$
				snapshot, Messages.PhantomReferenceStatQuery_Label_Referenced,
				Messages.PhantomReferenceStatQuery_Label_Retained,
				Messages.PhantomReferenceStatQuery_Label_StronglyRetainedReferents,
				listener);
	}
