	...
	private static class Node {
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			Node other = (Node) obj;
			return classLoaderId == other.classLoaderId && classLoaderAddress == other.classLoaderAddress
							...
							return new IContextObjectSet() {
								...
								public String getOQL() {
									if (node.classLoaderId >= 0)
										...
										return "select *" + " from java.lang.Class c"
												+ " where"
												+ " c implements org.eclipse.mat.snapshot.model.IClass"
												+ "     and c.@classLoaderAddress = "
												+ node.classLoaderAddress
												+ "L";
								}
							};
						}
