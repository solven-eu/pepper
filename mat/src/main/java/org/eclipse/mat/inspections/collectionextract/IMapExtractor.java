...
/**
 * MapExtractors are used to extract from the heap dump the contents of an object which represents a map of a certain
 * type. It knows the internal details of how the map contents are stored and if the collection has certain properties
 * or not
 *
 * @since 1.5
 */
public interface IMapExtractor extends ICollectionExtractor {
	 ...
	 * @return an Iterator over the entries. If the original Map had an Entry object, the content of the iterator would
	 *         usually be EntryObject
	 * @throws SnapshotException
	 */
